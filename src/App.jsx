...
const subgraphClient = new GraphQLClient(
  ...
  "https://api.studio.thegraph.com/query/33920/dai-goerli-test/v0.0.4",
  { mode: "cors" }
)
...
class App extends Component {
  ...
  all = async (blockNumber) => {
    ...
    let [[block, res], ethSupply, ethPriceNxt, ethPriceMedian, batPriceNxt, batPriceMedian,
      ...
      wstethPriceMedian, crvv1ethstethPriceNext, historicalDebt, allVaults] = await Promise.all(promises)
