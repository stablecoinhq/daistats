    ...
    <div>
      <div className="columns">
          ...
          <div className="has-text-centered">
            ...
            {ilk.lineMax > 0 && (
              <p className="title subtitle is-size-6">
                {t('maker.debt_ceiling')}: {formatAmount.format(ilk.lineMax)}
              </p>
            )}
            {ilk.lineMax > 0 && (
              <p className="title subtitle is-size-6">
            ...
            <p className="subtitle is-size-6">
              <a
                href="https://ipfs.io/ipfs/QmdFEcowhVbEabe68LMH8UuXweU8jnmQ7J28uUhFeeaY9X/"
                target="_blank"
        ...
        <div className="column">
          <div className="has-text-centered">
            <h3 className="title" title={ilk.tin}>
              {formatPercentFee.format(ilk.tin)}
            </h3>
            <p className="title subtitle is-size-4">Fee in</p>
            <h3 className="title" title={ilk.tout}>
              {formatPercentFee.format(ilk.tout)}
            </h3>
        ...
        <div className="column">
          <div className="has-text-centered">
            <h3 className="title" title={ilk.locked}>
              {formatNoDecimals.format(ilk.locked)}
            </h3>
            <p className="title subtitle is-size-4">{t('daistats.token_locked', { token: ilk.token })}</p>
            <p className="subtitle is-size-6">
              {t('daistats.token_supply_locked', { token: ilk.token })}: {formatPercent.format(ilk.locked / ilk.supply)}
            </p>
          </div>
        </div>
      </div>
